...
export const KEYS = {
  ...
  referralPhotoFileId: "referral_photo_file_id", // taklif rasmi (file_id — qayta ishlatish uchun)
  referralPhotoUrl:    "referral_photo_url",     // o'sha rasmning ochiq havolasi (kichik link-preview uchun)
